  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(3) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `car` (`carId` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `carName` TEXT, `car_price` INTEGER NOT NULL, `carYear` INTEGER NOT NULL, `maker` TEXT, `model` TEXT)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '7623a6992548ea68a5f1160d7ceb3a5e')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        final HashMap<String, TableInfo.Column> _columnsCar = new HashMap<String, TableInfo.Column>(6);
        ...
        _columnsCar.put("carYear", new TableInfo.Column("carYear", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsCar.put("maker", new TableInfo.Column("maker", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsCar.put("model", new TableInfo.Column("model", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
    ...
    }, "7623a6992548ea68a5f1160d7ceb3a5e", "4e234bf7266695c772828f01fe8d8a33");
